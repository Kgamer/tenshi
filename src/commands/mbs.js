...
class MbsCommand extends Command {
  ...
  async chatInputRun(interaction) {
    ...
    if (interaction.member.roles.cache.has('1070625539435532368') || interaction.member.roles.cache.has('940274217193201704')) { // Check if user is a moderator or has the Tenshi role
      if (!member.roles.cache.has('1208953626811433011')) { // Check if mention user already has the membership role
